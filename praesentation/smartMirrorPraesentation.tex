...
\begin{document}
	...
	\titlegraphic{
		\includegraphics[width=0.35\paperwidth]{images/spiegelVorneRechts}
	}
	...
	\begin{frame}
		...
		\begin{center}
			...
			\includegraphics[width = .6\paperwidth]{images/spiegelVorneRechts}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[scale=0.07]{images/20170603134109406iOS.jpg}
		\end{center}
	\end{frame}
		...
		\frametitle{Aktueller Status}
			\begin{columns}
				\column{.5\paperwidth}
					...
					\end{itemize}
				\column{.4\paperwidth}
					\includegraphics[width=.3\paperwidth]{images/spiegelVorneLinks}\\
					\vspace{.3cm}
					\includegraphics[width=.3\paperwidth]{images/spiegelRueckseite}
			\end{columns}
	\end{frame}

...
class NewsBlockFrame(Frame):
    ...
    def __init__(self, parent, width, height):
        ...
        self.title_label = Label(self, text="News", bg=background_color, fg=text_color, font=(font_type, 25))
        self.feed_text = Text(self, bg=background_color, fg=text_color, font=(font_type, 12), padx=20, pady=10, borderwidth=0)
    ...
    def update_text(self):
        ...
        for post in self.feed.entries:
            if count > 5:
                ...
                self.feed_text.insert(END, post.title + "\n\n")
